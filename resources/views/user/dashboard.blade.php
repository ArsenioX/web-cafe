            ...
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-success text-white fw-bold d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('cart.clear') }}" class="btn btn-sm btn-danger text-white">Reset</a>
                    </div>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="border-top pt-3 mt-auto">
                            <div class="d-flex justify-content-between align-items-end mb-3">
                                ...
                                <h3 class="fw-bold text-success mb-0">Rp {{ number_format($total_price ?? 0, 0, ',', '.') }}</h3>
                            </div>
                            ...
                            <form action="{{ route('transaction.process') }}" method="POST">
                                ...
                                <select name="payment_method" id="payment_method" class="form-select">
                                    ...
                                    <option value="CASHLESS">Dana / Gopay (Cashless)</option>
                                </select>
                                </div>
